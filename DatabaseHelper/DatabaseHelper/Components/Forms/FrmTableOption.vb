...
Public Class FrmTableOption
    ...
    ' Constructor for initializing form with database, table names, and connection
    ...
    ' Load data into the trigger combobox
    ...
    ' Retrieve tables for the table schema view
